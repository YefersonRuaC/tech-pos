...
<template>
    ...
    >
        ...
        <div class="space-y-2 flex-auto">
            ...
            <p><span class="font-medium">{{ product.availability }}</span> in existence</p>
        </div>
        ...
        <div class="flex items-center gap-3">
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6 text-gray-600 hover:text-gray-700">
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6 text-red-500 hover:text-red-600">
